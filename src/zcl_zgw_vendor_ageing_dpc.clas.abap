class ZCL_ZGW_VENDOR_AGEING_DPC definition
  public
...
protected section.
  ...
  methods DBUKNSET_CREATE_ENTITY
    importing
    ...
    exporting
      !ER_ENTITY type ZCL_ZGW_VENDOR_AGEING_MPC=>TS_DBUKN
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods DBUKNSET_DELETE_ENTITY
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
  ...
  methods DBUKNSET_GET_ENTITY
    ...
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods DBUKNSET_GET_ENTITYSET
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
    ...
    exporting
      !ET_ENTITYSET type ZCL_ZGW_VENDOR_AGEING_MPC=>TT_DBUKN
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods DBUKNSET_UPDATE_ENTITY
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
  ...
  methods KREDKSET_CREATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_ZGW_VENDOR_AGEING_MPC=>TS_KREDK
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods KREDKSET_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_ZGW_VENDOR_AGEING_MPC=>TT_KREDK
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods KREDKSET_UPDATE_ENTITY
    ...
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods VENDORAGEINGNOTE_CREATE_ENTITY
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_ZGW_VENDOR_AGEING_MPC=>TS_VENDORAGEINGNOTED
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods VENDORAGEINGNOTE_DELETE_ENTITY
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
    ...
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods VENDORAGEINGNOTE_GET_ENTITY
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
    ...
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods VENDORAGEINGNOTE_GET_ENTITYSET
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_ZGW_VENDOR_AGEING_MPC=>TT_VENDORAGEINGNOTED
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods VENDORAGEINGNOTE_UPDATE_ENTITY
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
    ...
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods VENDORAGEINGSET_CREATE_ENTITY
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_ZGW_VENDOR_AGEING_MPC=>TS_VENDORAGEING
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods VENDORAGEINGSET_DELETE_ENTITY
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
    ...
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods VENDORAGEINGSET_GET_ENTITY
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
  ...
  methods VENDORAGEINGSET_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_ZGW_VENDOR_AGEING_MPC=>TT_VENDORAGEING
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods VENDORAGEINGSET_UPDATE_ENTITY
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
...
CLASS ZCL_ZGW_VENDOR_AGEING_DPC IMPLEMENTATION.


  method VENDORAGEINGSET_UPDATE_ENTITY.
  ...
  method VENDORAGEINGSET_GET_ENTITY.
  RAISE EXCEPTION TYPE /iwbep/cx_mgw_not_impl_exc
    EXPORTING
      textid = /iwbep/cx_mgw_not_impl_exc=>method_not_implemented
      method = 'VENDORAGEINGSET_GET_ENTITY'.
  ...
  method VENDORAGEINGSET_DELETE_ENTITY.
  RAISE EXCEPTION TYPE /iwbep/cx_mgw_not_impl_exc
    EXPORTING
      textid = /iwbep/cx_mgw_not_impl_exc=>method_not_implemented
      method = 'VENDORAGEINGSET_DELETE_ENTITY'.
  ...
  method VENDORAGEINGSET_CREATE_ENTITY.
  RAISE EXCEPTION TYPE /iwbep/cx_mgw_not_impl_exc
    EXPORTING
      textid = /iwbep/cx_mgw_not_impl_exc=>method_not_implemented
      method = 'VENDORAGEINGSET_CREATE_ENTITY'.
  ...
  method VENDORAGEINGNOTE_UPDATE_ENTITY.
  RAISE EXCEPTION TYPE /iwbep/cx_mgw_not_impl_exc
    EXPORTING
      textid = /iwbep/cx_mgw_not_impl_exc=>method_not_implemented
      method = 'VENDORAGEINGNOTE_UPDATE_ENTITY'.
  ...
  method VENDORAGEINGNOTE_GET_ENTITYSET.
  RAISE EXCEPTION TYPE /iwbep/cx_mgw_not_impl_exc
    EXPORTING
      textid = /iwbep/cx_mgw_not_impl_exc=>method_not_implemented
      method = 'VENDORAGEINGNOTE_GET_ENTITYSET'.
  ...
  method VENDORAGEINGNOTE_GET_ENTITY.
  RAISE EXCEPTION TYPE /iwbep/cx_mgw_not_impl_exc
    EXPORTING
      textid = /iwbep/cx_mgw_not_impl_exc=>method_not_implemented
      method = 'VENDORAGEINGNOTE_GET_ENTITY'.
  ...
  method VENDORAGEINGNOTE_DELETE_ENTITY.
  RAISE EXCEPTION TYPE /iwbep/cx_mgw_not_impl_exc
    EXPORTING
      textid = /iwbep/cx_mgw_not_impl_exc=>method_not_implemented
      method = 'VENDORAGEINGNOTE_DELETE_ENTITY'.
  ...
  method VENDORAGEINGNOTE_CREATE_ENTITY.
  RAISE EXCEPTION TYPE /iwbep/cx_mgw_not_impl_exc
    EXPORTING
      textid = /iwbep/cx_mgw_not_impl_exc=>method_not_implemented
      method = 'VENDORAGEINGNOTE_CREATE_ENTITY'.
...
DATA lr_bukrs LIKE RANGE OF ls_converted_keys-bukrs.
DATA ls_bukrs LIKE LINE OF lr_bukrs.
DATA lr_ort01 LIKE RANGE OF ls_converted_keys-ort01.
DATA ls_ort01 LIKE LINE OF lr_ort01.
  ...
  CASE ls_filter-property.
    WHEN 'BUKRS'.              " Equivalent to 'Bukrs' property in the service
      ...
      LOOP AT lr_bukrs INTO ls_bukrs.
        ...
        ls_selopt-sign = ls_bukrs-sign.
        ls_selopt-shlpfield = 'BUKRS'.
        ls_selopt-shlpname = 'DBUKN'.
        APPEND ls_selopt TO lt_selopt.
        CLEAR ls_selopt.
      ENDLOOP.
    WHEN 'ORT01'.              " Equivalent to 'Ort01' property in the service
      lo_filter->convert_select_option(
        EXPORTING
          is_select_option = ls_filter
        IMPORTING
          et_select_option = lr_ort01 ).

      LOOP AT lr_ort01 INTO ls_ort01.
        ls_selopt-high = ls_ort01-high.
        ls_selopt-low = ls_ort01-low.
        ls_selopt-option = ls_ort01-option.
        ls_selopt-sign = ls_ort01-sign.
        ls_selopt-shlpfield = 'ORT01'.
        ls_selopt-shlpname = 'DBUKN'.
        APPEND ls_selopt TO lt_selopt.
        CLEAR ls_selopt.
      ENDLOOP.
...
LOOP AT lt_result_list INTO ls_result_list
  ...
  CASE ls_result_list-field_name.
    ...
    WHEN 'ORT01'.
      ls_entityset-ort01 = ls_result_list-field_value.
    WHEN 'BUTXT'.
...
LOOP AT lt_result_list INTO ls_result_list.
  ...
  CASE ls_result_list-field_name.
    WHEN 'ORT01'.
      er_entity-ort01 = ls_result_list-field_value.
    WHEN 'WAERS'.
...
*&* This class has been generated on 13.06.2018 12:05:43 in client 100
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_ZGW_VENDOR_AGEING_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA dbuknset_update_entity TYPE zcl_zgw_vendor_ageing_mpc=>ts_dbukn.
 DATA kredkset_update_entity TYPE zcl_zgw_vendor_ageing_mpc=>ts_kredk.
 DATA vendorageingset_update_entity TYPE zcl_zgw_vendor_ageing_mpc=>ts_vendorageing.
 DATA vendorageingnote_update_entity TYPE zcl_zgw_vendor_ageing_mpc=>ts_vendorageingnoted.
...
*     Call the entity set generated method
          dbuknset_update_entity(
               EXPORTING iv_entity_name     = iv_entity_name
             	 ...
             	 IMPORTING er_entity          = dbuknset_update_entity
          ).
       IF dbuknset_update_entity IS NOT INITIAL.
*     Send specific entity data to the caller interface
          copy_data_to_ref(
            EXPORTING
              is_data = dbuknset_update_entity
            CHANGING
              cr_data = er_entity
          ).
        ELSE.
...
*         In case of initial values - unbind the entity reference
        ...
        ENDIF.
*-------------------------------------------------------------------------*
*             EntitySet -  VendorAgeingSet
*-------------------------------------------------------------------------*
      WHEN 'VendorAgeingSet'.
*     Call the entity set generated method
          vendorageingset_update_entity(
               EXPORTING iv_entity_name     = iv_entity_name
                         iv_entity_set_name = iv_entity_set_name
                         iv_source_name     = iv_source_name
                         io_data_provider   = io_data_provider
                         ...
                         it_navigation_path = it_navigation_path
                         io_tech_request_context = io_tech_request_context
             	 IMPORTING er_entity          = vendorageingset_update_entity
          ).
       IF vendorageingset_update_entity IS NOT INITIAL.
*     Send specific entity data to the caller interface
          copy_data_to_ref(
            EXPORTING
              is_data = vendorageingset_update_entity
            CHANGING
              cr_data = er_entity
          ).
        ELSE.
*         In case of initial values - unbind the entity reference
        ...
        ENDIF.
*-------------------------------------------------------------------------*
*             EntitySet -  VendorAgeingNotedSet
*-------------------------------------------------------------------------*
      WHEN 'VendorAgeingNotedSet'.
*     Call the entity set generated method
          vendorageingnote_update_entity(
               EXPORTING iv_entity_name     = iv_entity_name
                         iv_entity_set_name = iv_entity_set_name
                         iv_source_name     = iv_source_name
                         io_data_provider   = io_data_provider
                         ...
                         it_navigation_path = it_navigation_path
                         io_tech_request_context = io_tech_request_context
             	 IMPORTING er_entity          = vendorageingnote_update_entity
          ).
       IF vendorageingnote_update_entity IS NOT INITIAL.
*     Send specific entity data to the caller interface
          copy_data_to_ref(
            EXPORTING
              is_data = vendorageingnote_update_entity
            CHANGING
              cr_data = er_entity
          ).
        ELSE.
...
*&*   generated methods inside the DPC provider subclass - ZCL_ZGW_VENDOR_AGEING_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA dbuknset_get_entityset TYPE zcl_zgw_vendor_ageing_mpc=>tt_dbukn.
 DATA kredkset_get_entityset TYPE zcl_zgw_vendor_ageing_mpc=>tt_kredk.
 DATA vendorageingset_get_entityset TYPE zcl_zgw_vendor_ageing_mpc=>tt_vendorageing.
 DATA vendorageingnote_get_entityset TYPE zcl_zgw_vendor_ageing_mpc=>tt_vendorageingnoted.
 DATA lv_entityset_name TYPE string.
...
*     Call the entity set generated method
      dbuknset_get_entityset(
        EXPORTING
         ...
         io_tech_request_context = io_tech_request_context
       IMPORTING
         et_entityset = dbuknset_get_entityset
         es_response_context = es_response_context
       ).
*     Send specific entity data to the caller interface
      copy_data_to_ref(
        EXPORTING
          is_data = dbuknset_get_entityset
        CHANGING
...
*     Call the entity set generated method
      vendorageingset_get_entityset(
        EXPORTING
         ...
         io_tech_request_context = io_tech_request_context
       IMPORTING
         et_entityset = vendorageingset_get_entityset
         es_response_context = es_response_context
       ).
*     Send specific entity data to the caller interface
      copy_data_to_ref(
        EXPORTING
          is_data = vendorageingset_get_entityset
        CHANGING
          cr_data = er_entityset
      ).
...
*-------------------------------------------------------------------------*
   WHEN 'VendorAgeingNotedSet'.
*     Call the entity set generated method
      vendorageingnote_get_entityset(
        EXPORTING
         iv_entity_name = iv_entity_name
         iv_entity_set_name = iv_entity_set_name
         iv_source_name = iv_source_name
         ...
         io_tech_request_context = io_tech_request_context
       IMPORTING
         et_entityset = vendorageingnote_get_entityset
         es_response_context = es_response_context
       ).
*     Send specific entity data to the caller interface
      copy_data_to_ref(
        EXPORTING
          is_data = vendorageingnote_get_entityset
        CHANGING
          cr_data = er_entityset
      ).
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA dbuknset_get_entity TYPE zcl_zgw_vendor_ageing_mpc=>ts_dbukn.
 DATA kredkset_get_entity TYPE zcl_zgw_vendor_ageing_mpc=>ts_kredk.
 DATA vendorageingset_get_entity TYPE zcl_zgw_vendor_ageing_mpc=>ts_vendorageing.
 DATA vendorageingnote_get_entity TYPE zcl_zgw_vendor_ageing_mpc=>ts_vendorageingnoted.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data.       "#EC NEEDED
...
*     Call the entity set generated method
          dbuknset_get_entity(
               EXPORTING iv_entity_name     = iv_entity_name
                         ...
                         it_navigation_path = it_navigation_path
                         io_tech_request_context = io_tech_request_context
             	 IMPORTING er_entity          = dbuknset_get_entity
                         es_response_context = es_response_context
          ).

        IF dbuknset_get_entity IS NOT INITIAL.
*     Send specific entity data to the caller interface
          copy_data_to_ref(
            EXPORTING
              is_data = dbuknset_get_entity
            CHANGING
              cr_data = er_entity
          ).
        ELSE.
...
*     Call the entity set generated method
          vendorageingset_get_entity(
               EXPORTING iv_entity_name     = iv_entity_name
                         ...
                         it_navigation_path = it_navigation_path
                         io_tech_request_context = io_tech_request_context
             	 IMPORTING er_entity          = vendorageingset_get_entity
                         es_response_context = es_response_context
          ).

        IF vendorageingset_get_entity IS NOT INITIAL.
*     Send specific entity data to the caller interface
          copy_data_to_ref(
            EXPORTING
              is_data = vendorageingset_get_entity
            CHANGING
              cr_data = er_entity
          ).
        ELSE.
...
*     Call the entity set generated method
          vendorageingnote_get_entity(
               EXPORTING iv_entity_name     = iv_entity_name
                         ...
                         it_navigation_path = it_navigation_path
                         io_tech_request_context = io_tech_request_context
             	 IMPORTING er_entity          = vendorageingnote_get_entity
                         es_response_context = es_response_context
          ).

        IF vendorageingnote_get_entity IS NOT INITIAL.
*     Send specific entity data to the caller interface
          copy_data_to_ref(
            EXPORTING
              is_data = vendorageingnote_get_entity
            CHANGING
              cr_data = er_entity
          ).
        ELSE.
...
*-------------------------------------------------------------------------*
      when 'VendorAgeingNotedSet'.
*     Call the entity set generated method
     vendorageingnote_delete_entity(
          EXPORTING iv_entity_name     = iv_entity_name
                    iv_entity_set_name = iv_entity_set_name
                    iv_source_name     = iv_source_name
                    it_key_tab         = it_key_tab
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA dbuknset_create_entity TYPE zcl_zgw_vendor_ageing_mpc=>ts_dbukn.
 DATA kredkset_create_entity TYPE zcl_zgw_vendor_ageing_mpc=>ts_kredk.
 DATA vendorageingset_create_entity TYPE zcl_zgw_vendor_ageing_mpc=>ts_vendorageing.
 DATA vendorageingnote_create_entity TYPE zcl_zgw_vendor_ageing_mpc=>ts_vendorageingnoted.
 DATA lv_entityset_name TYPE string.
...
*     Call the entity set generated method
    dbuknset_create_entity(
         EXPORTING iv_entity_name     = iv_entity_name
                   ...
                   it_navigation_path = it_navigation_path
                   io_tech_request_context = io_tech_request_context
       	 IMPORTING er_entity          = dbuknset_create_entity
    ).
*     Send specific entity data to the caller interfaces
    copy_data_to_ref(
      EXPORTING
        is_data = dbuknset_create_entity
      CHANGING
        cr_data = er_entity
   ).
...
*     Call the entity set generated method
    vendorageingset_create_entity(
         EXPORTING iv_entity_name     = iv_entity_name
                   ...
                   it_navigation_path = it_navigation_path
                   io_tech_request_context = io_tech_request_context
       	 IMPORTING er_entity          = vendorageingset_create_entity
    ).
*     Send specific entity data to the caller interfaces
    copy_data_to_ref(
      EXPORTING
        is_data = vendorageingset_create_entity
      CHANGING
        cr_data = er_entity
   ).
...
*-------------------------------------------------------------------------*
     WHEN 'VendorAgeingNotedSet'.
*     Call the entity set generated method
    vendorageingnote_create_entity(
         EXPORTING iv_entity_name     = iv_entity_name
                   iv_entity_set_name = iv_entity_set_name
                   iv_source_name     = iv_source_name
                   io_data_provider   = io_data_provider
                   ...
                   it_navigation_path = it_navigation_path
                   io_tech_request_context = io_tech_request_context
       	 IMPORTING er_entity          = vendorageingnote_create_entity
    ).
*     Send specific entity data to the caller interfaces
    copy_data_to_ref(
      EXPORTING
        is_data = vendorageingnote_create_entity
      CHANGING
        cr_data = er_entity
   ).

class ZCL_ZGW_VENDOR_AGEING_MPC definition
  public
...
public section.
  ...
  types:
         TS_VENDORAGEINGNOTED type ZST_VENDOR_AGEING .
  types:
    TT_VENDORAGEINGNOTED type standard table of TS_VENDORAGEINGNOTED .
  ...
  constants GC_VENDORAGEINGNOTED type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'VendorAgeingNoted' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZGW_VENDOR_AGEING_MPC=====CP' ##NO_TEXT.
  ...
  methods DEFINE_VENDORAGEING
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_VENDORAGEINGNOTED
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
ENDCLASS.
...
CLASS ZCL_ZGW_VENDOR_AGEING_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZGW_VENDOR_AGEING_SRV' ).

define_dbukn( ).
define_kredk( ).
define_vendorageing( ).
define_vendorageingnoted( ).
  endmethod.
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZGW_VENDOR_AGEING_MPC=>TS_DBUKN' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZGW_VENDOR_AGEING_MPC=>TS_KREDK' ). "#EC NOTEXT
...
lo_entity_set->set_filter_required( abap_false ).
  ...
  method DEFINE_VENDORAGEINGNOTED.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
***********************************************************************************************************************************
*   ENTITY - VendorAgeingNoted
***********************************************************************************************************************************

lo_entity_type = model->create_entity_type( iv_entity_type_name = 'VendorAgeingNoted' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'VendorAgeingNotedSet' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20180613120537'.                  "#EC NOTEXT
...
ls_text_element-artifact_name          = 'Openitemtotal'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'VendorAgeingNoted'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT

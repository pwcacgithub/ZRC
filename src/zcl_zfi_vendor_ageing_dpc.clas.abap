class ZCL_ZFI_VENDOR_AGEING_DPC definition
  public
...
protected section.
  ...
  methods DBUKNSET_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_ZFI_VENDOR_AGEING_MPC=>TS_DBUKN
    raising
  ...
  methods DBUKNSET_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_ZFI_VENDOR_AGEING_MPC=>TT_DBUKN
  ...
  methods KREDKSET_CREATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_ZFI_VENDOR_AGEING_MPC=>TS_KREDK
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods KREDKSET_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_ZFI_VENDOR_AGEING_MPC=>TT_KREDK
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods VENDORAGEINGSET_CREATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_ZFI_VENDOR_AGEING_MPC=>TS_VENDORAGEING
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods VENDORAGEINGSET_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_ZFI_VENDOR_AGEING_MPC=>TT_VENDORAGEING
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
...
CLASS ZCL_ZFI_VENDOR_AGEING_DPC IMPLEMENTATION.
...
*&* This class has been generated on 09.05.2018 08:34:46 in client 100
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_ZFI_VENDOR_AGEING_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA vendorageingset_update_entity TYPE zcl_zfi_vendor_ageing_mpc=>ts_vendorageing.
 DATA dbuknset_update_entity TYPE zcl_zfi_vendor_ageing_mpc=>ts_dbukn.
 DATA kredkset_update_entity TYPE zcl_zfi_vendor_ageing_mpc=>ts_kredk.
...
*&*   generated methods inside the DPC provider subclass - ZCL_ZFI_VENDOR_AGEING_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA vendorageingset_get_entityset TYPE zcl_zfi_vendor_ageing_mpc=>tt_vendorageing.
 DATA dbuknset_get_entityset TYPE zcl_zfi_vendor_ageing_mpc=>tt_dbukn.
 DATA kredkset_get_entityset TYPE zcl_zfi_vendor_ageing_mpc=>tt_kredk.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA vendorageingset_get_entity TYPE zcl_zfi_vendor_ageing_mpc=>ts_vendorageing.
 DATA dbuknset_get_entity TYPE zcl_zfi_vendor_ageing_mpc=>ts_dbukn.
 DATA kredkset_get_entity TYPE zcl_zfi_vendor_ageing_mpc=>ts_kredk.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data.       "#EC NEEDED
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA vendorageingset_create_entity TYPE zcl_zfi_vendor_ageing_mpc=>ts_vendorageing.
 DATA dbuknset_create_entity TYPE zcl_zfi_vendor_ageing_mpc=>ts_dbukn.
 DATA kredkset_create_entity TYPE zcl_zfi_vendor_ageing_mpc=>ts_kredk.
 DATA lv_entityset_name TYPE string.

class ZCL_ZGW_INVOICE_LISTIN_MPC definition
  public
...
public section.
  ...
  types:
         TS_INVOICELISTING type ZST_INVOICE_LISTING .
  types:
    TT_INVOICELISTING type standard table of TS_INVOICELISTING .
  types:
      begin of TS_HT001W,
     WERKS type WERKS_D,
     CITY1 type AD_CITY1,
  ...
  types:
    TT_HT001W type standard table of TS_HT001W .
  types:
      begin of TS_MEKKL,
     LIFNR type ELIFN,
     EKORG type EKORG,
  ...
  types:
    TT_MEKKL type standard table of TS_MEKKL .
  types:
      begin of TS_ZSHASSET,
     BUKRS type BUKRS,
     ANLN1 type ANLN1,
  end of TS_ZSHASSET .
  types:
    TT_ZSHASSET type standard table of TS_ZSHASSET .
  types:
      begin of TS_ZSHPYSTAT,
     PYSTAT type ZPAY_STAT,
  end of TS_ZSHPYSTAT .
  types:
    TT_ZSHPYSTAT type standard table of TS_ZSHPYSTAT .
  types:
      begin of TS_HWERKS,
     WERKS type WERKS_D,
     MATNR type MATNR,
  ...
  types:
    TT_HWERKS type standard table of TS_HWERKS .
  types:
      begin of TS_ZHT001W,
     WERKS type WERKS_D,
     CITY1 type AD_CITY1,
  ...
  types:
    TT_ZHT001W type standard table of TS_ZHT001W .

  constants GC_HT001W type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'HT001w' ##NO_TEXT.
  constants GC_HWERKS type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'HWerks' ##NO_TEXT.
  constants GC_INVOICELISTING type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'InvoiceListing' ##NO_TEXT.
  constants GC_KREDK type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'Kredk' ##NO_TEXT.
  constants GC_MEKKL type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'Mekkl' ##NO_TEXT.
  constants GC_ZHT001W type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'ZhT001w' ##NO_TEXT.
  constants GC_ZSHASSET type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'Zshasset' ##NO_TEXT.
  constants GC_ZSHPYSTAT type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'Zshpystat' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZGW_INVOICE_LISTIN_MPC====CP' ##NO_TEXT.

  methods DEFINE_KREDK
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_INVOICELISTING
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_HT001W
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_MEKKL
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_ZSHASSET
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_ZSHPYSTAT
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_HWERKS
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_ZHT001W
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
ENDCLASS.
...
CLASS ZCL_ZGW_INVOICE_LISTIN_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZGW_INVOICE_LISTING_SRV' ).

define_kredk( ).
define_invoicelisting( ).
define_ht001w( ).
define_mekkl( ).
define_zshasset( ).
define_zshpystat( ).
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'HT001w' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZGW_INVOICE_LISTIN_MPC=>TS_HT001W' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'HT001wSet' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'HWerks' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZGW_INVOICE_LISTIN_MPC=>TS_HWERKS' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'HWerksSet' ). "#EC NOTEXT
...
***********************************************************************************************************************************
*   ENTITY - InvoiceListing
***********************************************************************************************************************************

lo_entity_type = model->create_entity_type( iv_entity_type_name = 'InvoiceListing' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'PartyName' iv_abap_fieldname = 'PARTY_NAME' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Rmwwr' iv_abap_fieldname = 'RMWWR' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'PlantName' iv_abap_fieldname = 'PLANT_NAME' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 30 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Augdt' iv_abap_fieldname = 'AUGDT' ). "#EC NOTEXT
lo_property->set_type_edm_datetime( ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Rbstat' iv_abap_fieldname = 'RBSTAT' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZST_INVOICE_LISTING'
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'InvoiceListingSet' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZGW_INVOICE_LISTIN_MPC=>TS_KREDK' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'Mekkl' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZGW_INVOICE_LISTIN_MPC=>TS_MEKKL' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'MekklSet' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'ZhT001w' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZGW_INVOICE_LISTIN_MPC=>TS_ZHT001W' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'ZhT001wSet' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'Zshasset' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZGW_INVOICE_LISTIN_MPC=>TS_ZSHASSET' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'ZshassetSet' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'Zshpystat' iv_def_entity_set = abap_false ). "#EC NOTEXT

***********************************************************************************************************************************
*Properties
***********************************************************************************************************************************

lo_property = lo_entity_type->create_property( iv_property_name = 'Pystat' iv_abap_fieldname = 'PYSTAT' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZGW_INVOICE_LISTIN_MPC=>TS_ZSHPYSTAT' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'ZshpystatSet' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20180622135859'.                  "#EC NOTEXT
...
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'HT001w'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
ls_text_element-text_symbol            = '012'.              "#EC NOTEXT
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'City1'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'HT001w'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
ls_text_element-artifact_name          = 'Lifnr'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'Mekkl'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
ls_text_element-artifact_name          = 'Bukrs'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'Zshasset'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
ls_text_element-text_symbol            = '019'.              "#EC NOTEXT
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'Anln1'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'Zshasset'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
clear ls_text_element.
ls_text_element-artifact_name          = 'Pystat'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'Zshpystat'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
ls_text_element-artifact_name          = 'Werks'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'HWerks'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
ls_text_element-artifact_name          = 'Werks'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'ZhT001w'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
